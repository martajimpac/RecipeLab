 ...
 * @author Víctor
 */
@WebServlet(name = "EliminarListaServlet", urlPatterns = {"/EliminarListaServlet"})
public class EliminarListaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            ListaDB.removeList(request.getParameter("nombreLista"), user.getEmail());
        }catch(Exception e){
