 ...
 * @author teresa
 */
@WebServlet(name = "AsignarNuevaContrasena", urlPatterns = {"/AsignarNuevaContrasena"})
public class AsignarNuevaContrasena extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "/asignarNuevaContrasena.jsp";
        ...
        if (contrasena1.equals(contrasena2)) {
            ...
            if (usuario != null) {
                ...
                UsuarioDB.modificaContraseña(usuario);
                url = "/login.jsp";
            }
        } else {
